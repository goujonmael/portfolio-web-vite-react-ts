...
export function JavaSpringBootDetails() {
  return (
    <div>
      ...
      <p>- Icone, texte, couleur et police de caractère.</p>
      <img
      ...
      <p>- Création, modification, suppression et archivage.</p>
      <img
      ...
      <p>
        - Ajout de nouveaux matériaux/images. - Modification des anciens. -
        Suppression.
      </p>
    </div>
  );
